...
const Highlights = ({ limit }: IHighlightsProps) => {
  ...
  const rows: IHighlightsRows = [
    { icon: 'shop', text: 'Modelex', total: 172, stats: 3.9, increase: true },
    { icon: 'facebook', text: 'Yield', total: 85, stats: 0.7, increase: false },
    { icon: 'instagram', text: 'RAMM', total: 36, stats: 8.2, increase: true }
  ];

  const items: IHighlightsItems = [
    { badgeColor: 'badge-success', lebel: '$AI' },
    { badgeColor: 'badge-danger', lebel: '$%%%%' },
    { badgeColor: 'badge-info', lebel: '$RAMM' }
  ];
  ...
  return (
    <div className="card h-full">
      <div className="card-header">
        <h3 className="card-title">Your Token Allocations</h3>
      ...
      <div className="card-body flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
        <div className="flex flex-col gap-0.5">
          <span className="text-sm font-normal text-gray-700">Portfolio Valuation</span>
