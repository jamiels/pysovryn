...
import { AdminContext } from '@/pages/admin/providers';
import { useLoaders } from '@/providers';

const TokenProjects = () => {
  const { setProgressBarLoader, progressBarLoader } = useLoaders();
  const { fetchTokenProjectList, refreshTokenProjects, setTokenProjectCount, toggleAction } =
  ...
  const toggleProjectAction = (id: string, action: string) => {
          ...
          return (
            <label className="switch switch-sm">
              <input
                ...
                onChange={() => {
                  toggleProjectAction(row.original.project.id, 'visible');
                }}
              />
            </label>
          );
          ...
          return (
            <label className="switch switch-sm">
              <input
                ...
                onChange={() => {
                  toggleProjectAction(row.original.project.id, 'archive');
                }}
              />
            </label>
          );
