      ...
      <div className="grid lg:grid-cols-2 grow">
        ...
        <div className="lg:rounded-xl lg:border lg:border-gray-200 lg:m-5 order-1 lg:order-2 bg-top xxl:bg-center xl:bg-cover bg-no-repeat branded-bg">
          <div className="flex flex-col p-8 lg:p-16 gap-4">
            <Link to="/">
              <img
                src={toAbsoluteUrl('/media/app/yieldlogo.svg')}
            ...
            <div className="flex flex-col gap-3">
              <h3 className="text-2xl font-semibold text-gray-900">Yield</h3>
              <div className="text-base font-medium text-gray-600">
                The best token projects <span className="text-gray-900 font-semibold">live</span> on
                Yield
              </div>
            </div>
          </div>
