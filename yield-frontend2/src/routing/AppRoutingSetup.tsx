...
// New Pages
import { TokenProjectsTablePage } from '@/pages/projects';
import { TokenProjectsProvider } from '@/pages/projects/providers';
import { TokenProject } from '@/pages/projects/token-project';
import { TokenProjectsPage } from '@/pages/admin/token-projects';
import { AdminProvider } from '@/pages/admin/providers';
import { DocumentViewer } from '@/pages/projects/document-viewer';
      ...
      <Route element={<RequireAuth />}>
        <Route element={<Demo1Layout />}>
          ...
          <Route
            path="/token-projects/*"
            element={
              <TokenProjectsProvider>
                <Routes>
                  <Route path="/" element={<TokenProjectsTablePage />} />
                  <Route path="/:id" element={<TokenProject />} />
                  <Route path="doc/view/:id" element={<DocumentViewer />} />
                </Routes>
              </TokenProjectsProvider>
            }
          ></Route>
          ...
          <Route
            path="/inbound-projects/*"
            element={
              <AdminProvider>
                <Routes>
                  <Route path="/" element={<TokenProjectsPage />} />
                </Routes>
              </AdminProvider>
            }
          ></Route>
