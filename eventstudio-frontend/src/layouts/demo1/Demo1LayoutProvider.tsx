...
import { MenuSidebarHandler } from '@/config/menu.config';
...
const Demo1LayoutProvider = ({ children }: PropsWithChildren) => {
  ...
  const secondaryMenu = useMenuChildren(pathname, MenuSidebarHandler(), 0); // Retrieves the secondary menu

  // Sets the primary and secondary menu configurations
  setMenuConfig('primary', MenuSidebarHandler());
